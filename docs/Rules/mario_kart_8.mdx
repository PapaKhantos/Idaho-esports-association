...
There will not be an in-person state finals for Mario Kart 8. There will be an online Middle School State tournament after regular season play has concluded. Each school may bring one team to represent their school.
...
3. Overall Points of the two highest scoring heats of every regular season series.
     - This ensures that no team will receive undue advantage for winning in three heats, rather than two.
4. Overall game win percentage. (e.g. winning a match 2-0 is better than 2-1)
5. Higher opponents’ game win percentage. (e.g. it is better to beat an opponent who consistently won 2-0 than 2-1)
